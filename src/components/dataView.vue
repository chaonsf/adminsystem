                        ...
                        <div class="blockBtm">
                            ...
                            <div class="numberBox">
                                <div class="numberBoxList">
                                    <span>畜类：</span><em>0</em><span>头</span>
                                </div>
                                <div class="numberBoxList numberBoxListColor2">
                                    <span>禽类：</span><em>{{data.lsNormalCount}}</em><span>羽</span>
                                </div>
                            </div>
                    ...
                    <div class="blockCss blockBg3">
                        ...
                        <div class="blockBtm">
                            ...
                            <div class="numberBox">
                                ...
                                <div class="numberBoxList numberBoxListColor2">
                                    <span>禽类：</span><em>{{data.lairageCount}}</em><span>羽</span>
                                </div>
                            </div>
                            <div class="numberBox">
                                <div class="numberBoxList">
                    ...
                    <div class="blockCss blockBg4">
                        ...
                        <div class="blockBtm">
                            ...
                            <div class="numberBox">
                                ...
                                <div class="numberBoxList numberBoxListColor2">
                                    <span>禽类：</span><em>{{data.slaughterCount}}</em><span>羽</span>
                                </div>
                            </div>
                        ...
                        <div class="blockBtm">
                            ...
                            <div class="table">
                                <table>
                                    ...
                                    <tbody>
                                        <tr v-for="(item,index) in records" :key="index" v-show="index>=5?false:true" @click="changeFarm(item,index)" :class="index==0?'dataViewActive only':'only'">
                                            <td>{{index+1}}</td>
                                            <td>{{item.farmName}}</td>
            ...
            <div class="boxBottom clearfix povertyAllBox">
                ...
                <div class="povertyAll2">
                    <div class="povertyAll2List">
                        <p><i>0</i><span>户</span></p>
                        <p><span>2015年帮扶贫困户数量</span></p>
                    </div>
                    <div class="povertyAll2List">
                        <p><i>0</i><span>元</span></p>
                        <p><span>2015年贫困户平均增收</span></p>
                    </div>
                ...
                <div class="povertyAll3 povertyAll3_1">
                    ...
                    <div class="label">
                        <div class="block">
                            <p><i class="text1">0</i><span>头</span></p>
                            <p><span>贫困户畜类在栏数量</span></p>
                        </div>
                        <div class="block">
                            <p><i class="text2">0</i></p>
                ...
                <div class="povertyAll3 povertyAll3_2">
                    ...
                    <div class="label color2">
                        <div class="block">
                            <p><i class="text1">0</i><span>羽</span></p>
                ...
                <div class="povertyAll3 povertyAll3_3">
                    ...
                    <div class="label color3">
                        <div class="block">
                            <p><i class="text1">0</i><span>万元</span></p>
...
<script>
    ...
    import { getWeather } from '@/api/farm/diagram'
    import { gettrendsInfo,getDetail } from '@/api/dataView'
           ...
           this.todayWeek=todayWeek;
            ...
            getDetail(){
                getDetail(this.farmId).then(res=>{
                    const {photourl,farmName} = res.data.data
            ...
            changeFarm(data,index){
                ...
                this.getDetail()
               // this.getindexList()
                var shijian = [], shuizhi = [], tuzhi = [], wendu = [], shidu = [], co = []
                //获取dom容器
            ...
            getindexList(){
                getindexList(/* {farmId:this.farmId} */).then(res=>{
                    this.data = res.data
                    this.records = res.data.farms.records
            ...
            calculationScale() {
                var width = parseInt($(window).width()), calculation = 0, bodyWidth = 1920;
            ...
            $ml.click(function () {
                var parent = $(this).parents('.blockCss .topTitle').siblings('.blockBtm').find('.numberBox'), index = $(this).index();
                $(this).addClass('on').siblings().removeClass('on');
                parent.eq(index).show().siblings().hide();
            });

            //表格切换轮播
            $(".swiperBoxGroup .swiperBox").css({ "display": "none" });
            $(".swiperBoxGroup .swiperBox:first-child").css({ "display": "block" });
