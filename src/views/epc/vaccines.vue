        ...
        <template v-slot:status>
          ...
          <div class='content'>
            ...
            <el-table-column prop="variety" label="畜禽品种" align='center'> </el-table-column>
              ...
              <el-table-column prop="quantity" label="申请数量" align='center'> </el-table-column>
...
import { dictionary} from '@/api/poverty'
export default {
    components:{
        Query,Vaccinesmessage
    },
    data(){
        return{
            query: {
