...
<script>
import { getList, getDetail, add, update, remove } from "@/api/basic/device";
      ...
      option: {
        ...
        column: [
          ...
          },
          {
            ...
            row: true,
            search: true,
            dicUrl: "/api/blade-system/dict/dictionary?code=devicetype",
            props: {
              label: "dictValue",
              value: "dictKey"
            },
    ...
    beforeOpen(done, type) {
      if (["edit", "view"].includes(type)) {
        getDetail(this.form.id).then(res => {
          if (res.data.data.sukkId === -1) res.data.data.sukkId = null;
