<template>
    <basic-container>
        ...
        >
            ...
            <template slot-scope="menuScope" slot="menu">
                <span v-if="menuScope.row.status == 1">---</span>
                <el-button
                    v-if="menuScope.row.status == 0"
                    type="danger"
                    size="small"
                    @click="markRead(menuScope.row)"
                >
                    设为已读
                </el-button>
            </template>
