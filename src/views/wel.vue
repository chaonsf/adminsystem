            ...
            <p style="margin-left:18px;">
                <el-dropdown @command="selectChange">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item v-for="(item,index) in selectData" v-bind:key="index" :command='item' v-show="index>5?false:true">
                            {{item.farmName}}
                        </el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
    ...
    methods: {
        ...
        getindexList() {
            getindexList().then(res => {
                this.selectData = res.data.farms
                const {
                    data
                } = res
