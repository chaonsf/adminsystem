export default [
  {
    ...
    list: [
      ...
      "iconfont iconicon_fengkongguanli",
    ]
  },
  {
    label: "系统图标",
    list: [
      ...
      "iconfont icon-list_zhuanku",
      "iconfont icon-fengkongguanli",
      "iconfont icon-chuku",
      "iconfont icon-ruku",
      "iconfont icon-shouye",
      "iconfont icon-shiwu-1",
      "iconfont icon-pipeifangshi",
      "iconfont icon-cangchu",
      "iconfont icon-water_icon",
      "iconfont icon-clean-up",
      "iconfont icon-jiaoyu-",
      "iconfont icon-wj-cd",
      "iconfont icon-caigoudingdan",
      "iconfont icon-shiyongwendang",
      "iconfont icon-qinxulan",
      "iconfont icon-baoxianguanli",
      "iconfont icon-shiyong",
      "iconfont icon-iconfontzhizuobiaozhunbduan15",
      "iconfont icon-qiyong",
      "iconfont icon-erweima-scan-kuai",
      "iconfont icon-icon-cart",
      "iconfont icon-genghuanyuming",
      "iconfont icon-jiankangfupintongji",
    ]
  }
]
